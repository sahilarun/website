...
import hellodon from "../../../../public/footer/team.jpg";
import * as Scrollytelling from "~/lib/scrollytelling-client";
import QRImg from "../../../../public/footer/QR.svg";
import QRIMG2 from "../../../../public/footer/QRCode.svg";
...
import teamimage from "../../../../public/footer/team2.svg";
import { useMedia } from "../../../hooks/use-media";
import { toVw } from "../../../lib/utils";
import { useCallback, useEffect, useRef, useState } from "react";
import clsx from "clsx";

const ghHref = "https://github.com/zerexly";
      ...
      <footer className={s.footer}>
          ...
          <div className={s["QR-container"]}>
            ...
            >
              <a href={ghHref} target="_blank" rel="noreferrer">
                <Image className={s.QR} src={QRIMG2} alt="QR" />
              </a>
            </Scrollytelling.Animation>
          </div>
        </div>
        ...
        <div className={s.links}>
          ...
          <div>
            ...
            <Link
              className="link"
              href="mailto:tamish@ideahatchlabs.com"
              target="_blank"
              rel="noreferrer"
            >
              tamish@ideahatchlabs.com
            </Link>
          </div>
          <div>
            <span>@IdeaHatchLabs llc {new Date().getFullYear()}</span>
  ...
  return (
    <div className={s["pre-footer"]}>
      ...
      <div className={s["left-content"]}>
        <p>
          Now we are talking! Say hello to our developer.
        </p>
        <Terminal />
    ...
    <>
      <div className={s.terminal}>
        ...
        <DottedDiv className={s.content}>
          <p ref={contentRef}>github/zerexly</p>
          <button
            title="copy text"
...
const socials = [
  {
    name: "twitter",
    url: "https://twitter.com/zerexly",
  },
  {
    name: "instagram",
    url: "https://www.instagram.com/zerexly",
  },
  {
    name: "github",
    url: "https://github.com/zerexly",
  },
];
